...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ClearUseCaseFactory clearUseCaseFactory = new ClearUseCaseFactory();
            ClearController clearController = clearUseCaseFactory.create(viewManagerModel, clearViewModel, clearuserDataAccessObject);
